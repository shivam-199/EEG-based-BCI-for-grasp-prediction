...
for i=1:size(fileList)
    ...
    %EEG.chanlocs = pop_chanedit(EEG, 'load', {'AdultAverageNet64_v1.sfp' 'sfp'});
    ...
    EEG = pop_saveset(EEGref, 'filename', fileName(1:end-4), 'filepath', '/mnt/sda1/shivam/Thesis/Grasp Experiment/Data/PreprocessedData/ICs');
